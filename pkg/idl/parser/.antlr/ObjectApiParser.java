...
public class ObjectApiParser extends Parser {
	...
	public static final int
		...
		T__24=25, T__25=26, WHITESPACE=27, INTEGER=28, HEX=29, IDENTIFIER=30, 
		VERSION=31, DOCLINE=32, TAGLINE=33, COMMENT=34, DOT=35, LETTER=36, DIGIT=37, 
		UNDERSCORE=38, SEMICOLON=39;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'float'", "'float32'", "'float64'", "'string'", null, null, null, null, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, "WHITESPACE", "INTEGER", "HEX", "IDENTIFIER", "VERSION", 
			"DOCLINE", "TAGLINE", "COMMENT", "DOT", "LETTER", "DIGIT", "UNDERSCORE", 
			"SEMICOLON"
		};
	}
	...
	public final DocumentRuleContext documentRule() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 12884951064L) != 0)) {
				{
				{
				setState(45);
				declarationsRule();
	...
	public final InterfaceRuleContext interfaceRule() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 13958652160L) != 0)) {
				{
				{
				setState(110);
	...
	public final StructRuleContext structRule() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 13958643968L) != 0)) {
				{
				{
				setState(196);
				structFieldRule();
