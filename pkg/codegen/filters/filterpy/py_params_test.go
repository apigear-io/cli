...
func TestParams(t *testing.T) {
	...
	table := []struct {
		...
		{"test", "Test3", "opInt32", "self, param1: int"},
		{"test", "Test3", "opInt64", "self, param1: int"},
		{"test", "Test3", "opFloat", "self, param1: float"},
		{"test", "Test3", "opFloat32", "self, param1: float"},
		{"test", "Test3", "opFloat64", "self, param1: float"},
		...
		{"test", "Test3", "opInt32Array", "self, param1: list[int]"},
		{"test", "Test3", "opInt64Array", "self, param1: list[int]"},
		{"test", "Test3", "opFloatArray", "self, param1: list[float]"},
		{"test", "Test3", "opFloat32Array", "self, param1: list[float]"},
		{"test", "Test3", "opFloat64Array", "self, param1: list[float]"},
