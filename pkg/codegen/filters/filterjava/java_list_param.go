...
func ToListParamString(prefix string, schema *objmodel.Schema, name string) (string, error) {
	if schema == nil {
...
func javaListParam(prefix string, node *objmodel.TypedNode) (string, error) {
	if node == nil {
