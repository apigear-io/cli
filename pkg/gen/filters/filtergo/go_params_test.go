...
func TestParams(t *testing.T) {
	...
	table := []struct {
		...
		{"test", "Test3", "opBytes", "param1 []byte"},
		{"test", "Test3", "opAny", "param1 any"},
		...
		{"test", "Test3", "opBytesArray", "param1 [][]byte"},
		{"test", "Test3", "opAnyArray", "param1 []any"},
...
func TestParamsMultiple(t *testing.T) {
	table := []struct {
		...
		{"test", "Test5", "opBytesBytes", "param1 []byte, param2 []byte"},
		{"test", "Test5", "opAnyAny", "param1 any, param2 any"},
