...
func TestParams(t *testing.T) {
	table := []struct {
		...
		{"test", "Test3", "funcFloat", "input1: float"},
		{"test", "Test3", "funcString", "input1: str"},
		{"test", "Test3", "funcBoolArray", "input1: list[bool]"},
		{"test", "Test3", "funcIntArray", "input1: list[int]"},
		{"test", "Test3", "funcFloatArray", "input1: list[float]"},
		{"test", "Test3", "funcStringArray", "input1: list[str]"},
	}
	sys := loadSystem(t)
...
func TestParamsSymbols(t *testing.T) {
	table := []struct {
		...
		{"test", "Test4", "funcEnumArray", "input1: list[Enum1]"},
		{"test", "Test4", "funcStructArray", "input1: list[Struct1]"},
		{"test", "Test4", "funcInterfaceArray", "input1: list[Interface1]"},
	}
	sys := loadSystem(t)
	for _, tt := range table {
		t.Run(tt.pn, func(t *testing.T) {
