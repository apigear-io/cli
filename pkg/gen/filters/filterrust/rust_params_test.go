...
func TestParams(t *testing.T) {
	table := []struct {
		...
		{"test", "Test3", "opBoolArray", "param1: &Vec<bool>"},
		{"test", "Test3", "opIntArray", "param1: &Vec<i32>"},
		{"test", "Test3", "opInt32Array", "param1: &Vec<i32>"},
		{"test", "Test3", "opInt64Array", "param1: &Vec<i64>"},
		{"test", "Test3", "opFloatArray", "param1: &Vec<f32>"},
		{"test", "Test3", "opFloat32Array", "param1: &Vec<f32>"},
		{"test", "Test3", "opFloat64Array", "param1: &Vec<f64>"},
		{"test", "Test3", "opStringArray", "param1: &Vec<String>"},
...
func TestParamsSymbols(t *testing.T) {
	table := []struct {
		...
		{"test", "Test4", "opEnumArray", "param1: &Vec<Enum1Enum>"},
		{"test", "Test4", "opStructArray", "param1: &Vec<Struct1>"},
		{"test", "Test4", "opInterfaceArray", "param1: &Vec<&Interface1>"},
	}
	syss := loadTestSystems(t)
	for _, sys := range syss {
		for _, tt := range table {
